...
from RUN_Analysis_4 import start_string, global_seed, analysis_path, use_preoptimised_model, preoptimised_model, version

if use_preoptimised_model == False:
    results_path = analysis_path + "Results/Performance_all/"

if use_preoptimised_model == True:
    results_path = "Analysis_{}{}/Results/Performance_all/".format(preoptimised_model, version)

#     todo: when have trained models - create a catelogue of the strings to import from
