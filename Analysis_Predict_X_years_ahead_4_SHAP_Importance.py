...
from Functions.Plotting import plot_SHAP, plot_SHAP_over_time, get_custom_palette, \
    heatmap_importance, plot_SHAP_interaction, plot_SHAP_summary_interaction, plot_SHAP_interact_dependency, plot_long, \
    plot_SHAP_over_time_exp
from Functions.Preprocessing import get_var_names_dict, remove_col, shap_dict_to_long_df
from RUN_Predict_X_years_ahead_New import start_string, global_seed, analysis_path, final_data_path, anal_level, directory_bits,\
    version, Additional_pred_checks, Choose_drop_DV_T1
from Fixed_params import cat_vars, drop_list, block_file, changes
shap.initjs()
...
data_save_path = final_data_path
# start_string = "_12_Dec_2022__09.27"
...
# time_date_string = "_09_Dec_2022__15.27_test"
# -------
...
var_names_df = pd.DataFrame.from_dict(var_names_dict, orient="index").reset_index()
...
if (only_over_time == True) or (only_df2 == True):
    models = ["Enet", "RF"]
    for model in models:
...
if anal_level == "indiv":
    ...
    plot_SHAP_over_time(x="Time", y="Abs_SHAP", data=enet_subgroup,
                        ...
                        save_name = "New_Enet_abs_sum_indiv_{}".format(start_string),
                        xticks = xticks,
                        xlab="School Year",
    ...
    plot_SHAP_over_time(x="Time", y="Abs_SHAP", data=rf_subgroup,
                        colour="variable", save_path = save_path,
                        save_name = "RF_abs_sum_indiv_{}".format(start_string),
                        xticks = xticks,
...
if anal_level == "block":
    ...
    plot_SHAP_over_time(x="Time", y="Abs_SHAP", data=enet_group,
                        ...
                        save_name = "New_Enet_block_abs_sum{}{}{}".format(start_string, t5, changes),
                        xticks = xticks,
                        xlab="School Year",
                        ylab="SHAP Importance on Test Data",
                        title = "Elastic Net",
    ...
    plot_SHAP_over_time_exp(x="Time", y="Abs_SHAP", data=enet_group,
                        colour="block", save_path = save_path,
                        save_name = "EXP_Enet_abs_sum_indiv_{}".format(start_string),
                        xticks = xticks,
                        xlab="Schooling Year (Grade)",
                        ylab="SHAP Importance on Test Data",
                        title = "",
    ...
    plot_SHAP_over_time_exp(x="Time", y="Abs_SHAP", data=rf_group,
                        colour="block", save_path = save_path,
                        save_name = "EXP_RF_abs_sum_indiv_{}".format(start_string),
                        xticks = xticks,
                        xlab="Schooling Year (Grade)",
                        ylab="SHAP Importance on Test Data",
                        title = "", size=0.01,
