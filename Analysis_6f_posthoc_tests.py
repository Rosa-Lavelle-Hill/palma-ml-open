...
for file in os.listdir(directory_bits):
    ...
    if filename.endswith("_preprocessed{}.csv".format(version)):
        ...
        mae_lin_regr = abs(y_test - lin_regr_y_pred)
        ...
        t_lr_lm, p_lr_lm = scipy.stats.ttest_rel(mae_lin_regr, mae_lm, axis=0, nan_policy='propagate')
        t_lr_rf, p_lr_rf = scipy.stats.ttest_rel(mae_lin_regr, mae_rf, axis=0, nan_policy='propagate')
        t_lr_d, p_lr_d = scipy.stats.ttest_rel(mae_dum, mae_lin_regr, axis=0, nan_policy='propagate')
