...
from RUN_Analysis_1 import start_string, global_seed, t, analysis_path, version
...
for file in os.listdir(directory_bits):
    ...
    if filename.endswith("_preprocessed{}.csv".format(version)):
        ...
        drop_list = ["Unnamed: 0", "Unnamed: 0.1", "vpnr", "index", "laeng12345", "vpnrg_u"]
        ...
        if data_used == 'full':
            ...
            if permutations == 1:
                ...
                plot_perm(df=perm_imp_df, n_plot=n_plot, save_path=fig_save_path_full,
                          ...
                          x='Importance', y='Feature',
                          save_name="df{}_RF_permutation_{}{}{}.png".format(df_num, scoring, time_date_string, t))
            else:
...
print("permuatation importance runtime: {}".format(run_time))
