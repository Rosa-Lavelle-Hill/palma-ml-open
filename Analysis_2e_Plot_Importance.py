...
from RUN_Analysis_2 import start_string, global_seed, t, perm_cut_off, analysis_path
...
# time_date_string = "_30_Nov_2022__17.22"
...
if heat_map == True:
    ...
    # Enet
    heatmap_importance(df=df_long_enet_test_full, index="Feature", xticks=xticks,
                       columns="Time", values="Importance", title="Elastic Net", xlab="School year",
                       ylab="Feature", save_name="Heatmap_Enet_g{}_{}".format(gamma, time_date_string),
                       save_path=save_plot_path, gamma=gamma, adjust_left=0.4, figsize=(8, 12))
    # RF
    heatmap_importance(df=df_long_rf_test_full, index="Feature", xticks=xticks,
                       columns="Time", values="Importance", title="Random Forest", xlab="School year",
                       ylab="Feature", save_name="Heatmap_RF_g{}_{}".format(gamma, time_date_string),
                       save_path=save_plot_path, gamma=gamma, adjust_left=0.4, figsize=(8, 12))
