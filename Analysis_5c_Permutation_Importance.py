...
from RUN_Analysis_5 import start_string, global_seed, analysis_path, data_path, version
from Fixed_params import drop_list, cat_vars, cat_vars_agg

start_time = dt.datetime.now()
# start_string = "_19_Jun_2022__17.40_test"
# ^test string
# ----
permutations = 1
data_used = 'test'
