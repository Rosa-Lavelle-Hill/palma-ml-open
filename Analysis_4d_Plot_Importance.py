...
from Functions.Plotting import plot_long, get_custom_palette, heatmap_importance, plot_long_old
from Functions.Preprocessing import get_var_names_dict
from RUN_Analysis_4 import start_string, global_seed, t, analysis_path, Include_T5, Choose_drop_DV_T1
...
if Include_T5 == False:
    del RF_test_var_imp_dict['5']
    del Enet_test_var_imp_dict['5']
    dfs = ['1', '2', '3', '4']
else:
    dfs = ['1', '2', '3', '4', '5']
...
if Include_T5 == False:
    ...
    times = [1, 2, 3, 4, 5]
# RF
plot_long_old(x='Time', y='Importance', data=df_long_rf_test_full, colour="Feature_Block", save_path=save_plot_path,
          ...
          title=" ")
# Enet
plot_long_old(x='Time', y='Importance', data=df_long_enet_test_full, colour="Feature_Block", save_path=save_plot_path,
...
if Choose_drop_DV_T1 == False:
    ...
    plot_long_old(x='Time', y='Normalised_Importance', data=models_norm_dict["Enet"], colour="Feature_Block", save_path=save_plot_path,
                  ...
                  title="Elastic Net")
    # RF
    plot_long_old(x='Time', y='Normalised_Importance', data=models_norm_dict["RF"], colour="Feature_Block", save_path=save_plot_path,
